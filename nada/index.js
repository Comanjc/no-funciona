...
function save(obj){    
    ...
    if(estado==0){
        ...
        "<a href='#' class='icono2 dos' onclick='editar(this)'><i class='fa-solid fa-pen-to-square'></i></a>"
        +"<a href='#' class='icono1 uno' onclick='eliminar(this)'><i class='fa-solid fa-trash'></i></a>"
